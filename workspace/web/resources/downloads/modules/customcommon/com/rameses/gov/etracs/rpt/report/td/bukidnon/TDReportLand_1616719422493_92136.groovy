/*
 * Generated by JasperReports - 3/26/21 8:43 AM
 */
 ...
 *
 */
class TDReportLand_1616719422493_92136 extends JREvaluator
{
    ...
    Object evaluate(int id)
    {
        ...
        {
            value = (java.lang.String)(( new DecimalFormat("#,##0").format(((java.math.BigDecimal)field_assesslevel.getValue()))).toString() + "%");
        }
        else if (id == 24)
        {
            value = (java.math.BigDecimal)(((java.math.BigDecimal)field_assessedvalue.getValue()));
    ...
    Object evaluateOld(int id)
    {
        ...
        {
            value = (java.lang.String)(( new DecimalFormat("#,##0").format(((java.math.BigDecimal)field_assesslevel.getOldValue()))).toString() + "%");
        }
        else if (id == 24)
        {
            value = (java.math.BigDecimal)(((java.math.BigDecimal)field_assessedvalue.getOldValue()));
